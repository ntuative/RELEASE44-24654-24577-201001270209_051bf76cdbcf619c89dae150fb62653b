package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_553.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_46)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_126,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_840,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_153,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_158,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_47,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_447,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_608,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_844,onHideWindowEvent);
         var_46 = true;
