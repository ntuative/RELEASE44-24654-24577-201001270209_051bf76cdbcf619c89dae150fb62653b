package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            var_871 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_870.push(new XML());
               var_872.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_872[var_63] = param6.clone();
         }
      ...
      {
         if(var_1296 == true || var_705 == 0)
         {
            if(false)
            {
               ++var_63;
               if(var_63 >= var_870.length)
               {
                  var_63 = 0;
                  ++var_705;
               }
      ...
      {
         return var_870.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1296 == false && var_705 == 1 && var_1125 != var_46;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_871 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_871.width),Math.max(param2.height,var_871.height));
            _loc3_.copyPixels(var_871,var_871.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_63 <= var_872.length)
         {
            _loc2_ = var_872[var_63];
