package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1081:Number = 90;
      
      private static const const_758:int = 50;
      
      private static const const_1080:Number = 25;
      
      private static const const_1097:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1007 = param2;
         var_576 = new Timer(const_1080);
         var_576.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_495.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_495.splice(_loc3_,1);
            var_494.splice(_loc3_,1);
         }
         var_494.push(param1.name);
         var_495.push(param2);
         param1.addEventListener(WindowEvent.const_393,windowEventListener);
         param1.addEventListener(WindowEvent.const_184,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_495[var_494.indexOf(param1)];
      }
      ...
      {
         return var_494[var_495.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_575[_loc3_] = new Array();
            }
            if(var_575[_loc3_].indexOf(param1) < 0)
            {
               var_575[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_758 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_758 || param1.desktop.height - param1.y < const_1097;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_494[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_575[_loc3_].length)
                  {
                     repositionWindow(var_575[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
