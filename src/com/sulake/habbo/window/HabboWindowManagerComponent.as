package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_333:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1037:uint = 1;
      ...
      private var var_1138:ProfilerAgentTask;
      
      private var var_1141:IEventDispatcher;
      
      private var var_2324:uint = 0;
      
      private var var_1139:ProfilerAgentTask;
      
      private var var_1140:ProfilerOutput;
      
      private var var_633:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_203 = CoreComponent(param1).root.stage;
            _instance = this;
      ...
      {
         return var_291[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_291[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_633 = new WindowRenderer(_loc4_);
         var_291 = new Array(const_333);
         var _loc6_:int = 0;
         while(_loc6_ < const_333)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_633,this,_localization,var_203,new Rectangle(0,0,var_203.stageWidth,var_203.stageHeight),this);
            var_291[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_388 = var_291[const_1037];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_388.getMouseCursor().defineCustomCursorType(MouseCursorType.const_309,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_388.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1360,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_291[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_291.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_291[param1].getDesktopWindow().getChildAt(var_388.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1140 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1140 = new ProfilerOutput(_loc3_,this,var_633);
               var_1138 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1138);
               var_1139 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1139);
               var_942 = true;
            }
         }
      }
      ...
      {
         return var_388.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         _loc2_ = 0;
         while(_loc2_ < const_333)
         {
            var_291[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_942)
         {
         ...
         if(WindowContext.var_889.length > 0)
         {
            WindowContext.var_889.flush();
         }
         if(WindowContext.var_1318.length > 0)
         {
            WindowContext.var_1318.flush();
         }
      ...
      {
         var _loc3_:Dictionary = var_765[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_765[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_388.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1132,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1206,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1180,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1361,param2.name + ": " + param2.toString());
            }
         }
      }
   }
