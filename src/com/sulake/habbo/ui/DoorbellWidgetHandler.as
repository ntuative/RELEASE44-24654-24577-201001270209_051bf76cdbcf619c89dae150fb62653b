package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_99:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_528,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_562];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_562:
      ...
      {
         return [RoomSessionDoorbellEvent.const_99,RoomSessionDoorbellEvent.const_120,RoomSessionDoorbellEvent.const_117];
      }
