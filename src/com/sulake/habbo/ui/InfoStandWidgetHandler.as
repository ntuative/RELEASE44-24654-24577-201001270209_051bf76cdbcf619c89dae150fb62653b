package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_492);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_295);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_801);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_924);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_390)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_810)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_642);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_221)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1218;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_887;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1243);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_584.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_584.add(_loc2_.petId,_loc5_);
         }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_103];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_262);
         _loc1_.push(RoomWidgetFurniActionMessage.const_628);
         _loc1_.push(RoomWidgetFurniActionMessage.const_674);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_614);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_520);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1186);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_103:
      ...
      public function dispose() : void
      {
         ...
         if(var_584 != null)
         {
            _loc1_ = var_584.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_584.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_650:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_851,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_426:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_614:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_520:
