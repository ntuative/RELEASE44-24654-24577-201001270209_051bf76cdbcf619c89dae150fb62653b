package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_407:
               ...
               {
                  case RoomSessionQueueEvent.const_923:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_934:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.method_2(RoomSessionQueueEvent.const_994) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.method_2(RoomSessionQueueEvent.const_1320) + 1;
                  }
               }
               else
               {
                  _loc6_ = _loc2_.method_2(_loc5_[0]) + 1;
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_539);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_934);
               break;
            case RoomWidgetRoomQueueMessage.const_569:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_923);
               break;
            case RoomWidgetRoomQueueMessage.const_539:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_320,true);
               }
         }
         return null;
      }
