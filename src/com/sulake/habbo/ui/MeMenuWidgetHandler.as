   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_840,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_587,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_437,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_587,onFigureUpdate);
         ...
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_945,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_711,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_437,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_101,onHelpTutorialEvent);
         }
         var_95 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_437:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_353));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_563);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_683);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_573);
         _loc1_.push(RoomWidgetStopEffectMessage.const_530);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1188);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_970);
         ...
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_578);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_542);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_646);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_648);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1279);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_700);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_574);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_676);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_531));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_542:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetWaveMessage.const_563:
               if(_container != null && false)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_573:
               ...
               if(var_95 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_660)
               {
                  var_95.openCatalogPage(CatalogPageName.const_320,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_683:
               ...
               if(var_25 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_899:
                        var_95.openCatalogPage(CatalogPageName.const_1246,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_859:
                        var_25.toggleInventoryPage(InventoryCategory.const_234);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1125:
            ...
            case RoomWidgetStopEffectMessage.const_530:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_804:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_970:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_578:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_512:
               ...
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_95 != null && var_95.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_95.getPurse().credits));
                  }
               }
               if(false)
               {
            ...
            case RoomWidgetToolbarMessage.const_499:
               ...
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_447,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_710:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_341,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_988));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_341,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1277));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_689));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_646:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_648:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_700:
            ...
            case RoomWidgetStoreSettingsMessage.const_574:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_676:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_510));
               }
               break;
            default:
