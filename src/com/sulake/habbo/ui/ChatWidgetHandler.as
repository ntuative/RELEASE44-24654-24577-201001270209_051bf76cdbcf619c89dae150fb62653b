package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_491:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_492 != null)
         {
            ...
            {
               _loc2_ = var_492.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_148:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _container.roomEngine.getRoomCanvasGeometry(_loc3_.session.roomId,_loc3_.session.roomCategory,_container.method_6());
                     if(_loc5_ != null)
                     {
                        updateWidgetPosition();
                        _loc6_ = 0;
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_492.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_689.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_492.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_689.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_506,RoomWidgetChatSelectAvatarMessage.const_686];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_506:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 24654-24577-201001270140");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_288);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_364);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                              _container.sessionDataManager.method_11(_container.roomSession.roomId,_container.roomSession.roomCategory);
                              return null;
                           case ":news":
                              if(false)
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_686:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         var _loc1_:int = _container.method_6();
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_848 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_848);
            }
            if(var_491 == null)
            {
               var_493.x = 0;
               var_493.y = 0;
               var_493.z = 0;
               var_491 = _loc4_.getScreenPoint(var_493);
               var_848 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_493.x = 0;
            var_493.y = 0;
            var_493.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_493);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_491.x || _loc8_.y != var_491.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_491,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_305;
      }
