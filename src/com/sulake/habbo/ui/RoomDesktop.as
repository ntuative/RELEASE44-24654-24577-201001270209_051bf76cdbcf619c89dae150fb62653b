package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_234:DesktopLayoutManager;
      ...
      private var var_1875:IHabboHelp = null;
      ...
      private var var_794:IRoomWidgetFactory = null;
      ...
      private var var_1186:IAvatarRenderManager = null;
      ...
      private var var_529:ISessionDataManager = null;
      
      private var var_2075:uint = 16777215;
      
      private var var_95:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_233 = new Map();
         var_234 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_327,onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         {
            var_688 = _roomEngine.loadRoomResources(var_49.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_467 != null && true)
         {
            var_1254 = !var_467.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_49.roomId,var_49.roomCategory,var_274[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_233 != null)
         {
            ...
            {
               _loc5_ = var_233.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_327,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2075);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_233.length)
         {
            _loc2_ = var_233.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_234.setLayout(param1,_windowManager);
         if(var_189 != null)
         {
            var_234.toolbarSize = var_189.size;
            var_234.toolbarOrientation = var_189.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_225:
               _loc3_ = "null";
               break;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_274[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_794.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_234.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_233.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_234.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_234 != null)
         {
            var_234.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_630:
               ...
               if(var_1419 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_49.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_390)
                  {
                     var_1419.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_231:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_458:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_186,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_233.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_234.roomViewRect;
         var _loc3_:int = _loc2_.width;
         var _loc4_:int = _loc2_.height;
         var _loc5_:int = 0;
         if(var_274.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_543);
            _loc13_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_634);
            _loc14_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_698);
            _loc15_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_649);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_225,canvasMouseHandler);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_49 != null)
            {
               _loc2_ = _roomEngine.getRoomCanvasGeometry(var_49.roomId,var_49.roomCategory,method_6());
               if(_loc2_ != null)
               {
                  _loc2_.performZoom();
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_401:
               ...
               var_183 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_264,WindowParam.const_82) as IToolTipWindow;
               var_183.setParamFlag(WindowParam.const_49,false);
      ...
      {
         if(var_688 == null || false)
         {
            return;
         }
         var _loc2_:int = var_688.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_688.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_34 != null && var_49 != null && var_1254 && var_9)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_234.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
