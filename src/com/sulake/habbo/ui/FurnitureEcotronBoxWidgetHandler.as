package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_511,RoomWidgetEcotronBoxOpenMessage.const_552,RoomWidgetEcotronBoxOpenedMessage.const_1284];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_511:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_552:
