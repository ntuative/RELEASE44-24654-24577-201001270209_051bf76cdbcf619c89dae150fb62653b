package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_554 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_554.width;
         var_102 = var_554.height;
         var_975 = param5;
         var_806 = param6;
         var_223 = Math.floor(var_975 / _thumbWidth);
         var_32 = new BitmapData(var_975,var_806);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         _loc2_ = new Rectangle((param1.x + 1) * _thumbWidth,param1.y * var_102,_loc4_ * _thumbWidth,var_102);
         _loc3_ = new Point(param1.x * _thumbWidth,param1.y * var_102);
         ...
         if(param1.y < var_474 - 1)
         {
            _loc7_ = 0 - _thumbWidth;
            _loc8_ = 0 - (param1.y + 1) * var_102;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(_thumbWidth,(param1.y + 1) * var_102,_loc9_.width,_loc9_.height);
            ...
            var_32.fillRect(new Rectangle(0,0 - var_102,var_32.width,var_102),4294967295);
            _loc3_ = new Point(0 - _thumbWidth,_loc2_.y - var_102);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_32.width,0 - var_102);
               _loc2_ = new Rectangle(0,0,var_32.width,0 - var_102);
               _loc11_.copyPixels(var_32,_loc2_,new Point(0,0),null,null,true);
               var_32 = _loc11_;
               --var_474;
            }
         }
         if(var_32.height < var_806)
         {
            _loc12_ = new BitmapData(var_32.width,var_806);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_554.width,var_554.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_554.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_554,var_554.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_474 = resolveRowCountFromList();
         if(var_474 == 0)
         {
            var_32 = new BitmapData(var_975,var_806);
            return;
         }
         var_32 = new BitmapData(Math.max(var_223 * _thumbWidth,var_975),Math.max(var_474 * var_102,var_806),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_474)
         {
            _loc4_ = 0;
            while(_loc4_ < var_223)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_32.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_102),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_223 && var_32.height < _loc3_.y * var_102)
         {
            _loc2_ = new BitmapData(var_32.width,var_32.height + var_102);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_223 - 1),var_102);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_223 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_102),null,null,true);
         _loc4_ = new Rectangle(0,var_102,_thumbWidth * (var_223 - 1),0 - var_102);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,var_102),null,null,true);
         var_32 = _loc2_;
      }
      ...
      {
         var _loc2_:int = Math.floor(param1.y / var_102);
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * _thumbWidth,_loc3_.y * var_102);
