package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2228:BitmapData;
      
      protected var var_892:Boolean;
      ...
      protected var var_359:BitmapData;
      
      private const const_1386:Number = 0.2;
      
      protected var var_1322:Boolean;
      
      private const const_1385:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_675)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1350));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1322 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2228;
               _loc5_.visible = true;
            }
            else
            {
