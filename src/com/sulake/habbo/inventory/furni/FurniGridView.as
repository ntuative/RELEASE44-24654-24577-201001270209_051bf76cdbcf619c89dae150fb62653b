package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         var_460.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_29 && var_335 != null && var_335 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_225)
         {
