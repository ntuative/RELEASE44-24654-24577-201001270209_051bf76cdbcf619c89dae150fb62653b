package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_306:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_183,onObjectPlaced);
         var_508 = new Timer(const_1112,1);
         var_508.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_675)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_183,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_508 != null)
            {
               var_508.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_508.stop();
               var_508 = null;
            }
            if(var_148 != null)
            {
               var_148.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_148.stop();
               var_148 = null;
            }
            if(var_713 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_299)
         {
         ...
         else if(param3 == FurniCategory.const_277)
         {
         ...
         if(var_713 == null)
         {
            var_713 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_713.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_258:
               ...
               break;
            case InventorySubCategory.const_833:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_148 = new Timer(param1,1);
            var_148.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_148.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_457);
         ...
         if(param1 == InventoryCategory.const_72 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_306:
                  _controller.toggleInventoryPage(InventoryCategory.const_160);
            }
         }
      }
      ...
      {
         if(var_884 && param1.type == RoomEngineObjectEvent.const_183)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_277 || _loc3_.category == FurniCategory.const_299 || _loc3_.category == FurniCategory.const_286)
         {
            if(param1)
            {
               return false;
      ...
      public function clearFurniList() : void
      {
         ...
         var_424.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
