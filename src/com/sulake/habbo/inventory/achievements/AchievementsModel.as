package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsModel implements IInventoryModel
   {
      ...
      public function AchievementsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_529 = param6;
         var_529.events.addEventListener(BadgeImageReadyEvent.const_112,onBadgeImageReady);
         var_324 = new Array();
      ...
      public function addAchievement(param1:Achievement, param2:Boolean = true) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_324.length)
         {
            _loc5_ = var_324[_loc4_] as Achievement;
            if(_loc5_.type == param1.type && _loc5_.level < param1.level)
            {
               _loc5_.level = param1.level;
               _loc5_.badgeId = param1.badgeId;
               _loc5_.image = var_529.getBadgeImage(param1.badgeId);
               _loc3_ = true;
            }
            _loc4_++;
         }
         if(!_loc3_)
         {
            param1.image = var_529.getBadgeImage(param1.badgeId);
            var_324.push(param1);
         }
         if(param2)
         {
      ...
      public function removeAchievement(param1:String, param2:int) : void
      {
         ...
         _loc4_ = var_324[0] as Achievement;
      ...
      {
         if(param1 == InventoryCategory.const_296 && false)
         {
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_529 != null)
            {
               var_529.events.removeEventListener(BadgeImageReadyEvent.const_112,onBadgeImageReady);
               var_529 = null;
            }
            _disposed = true;
         }
      ...
      public function getAchievements() : Array
      {
         ...
         {
            _loc3_ = var_324[_loc2_] as Achievement;
            _loc1_.push(_loc3_);
            _loc2_++;
         }
         return _loc1_;
