package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_300:PetsGridItem;
      ...
      {
         if(var_557 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_557.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_300 != null)
         {
            var_300.setSelected(false);
         }
         var_300 = param1;
         if(var_300 != null)
         {
            var_300.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_300.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_557.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_557.getValue(param1.id) != null)
         {
            return;
         }
