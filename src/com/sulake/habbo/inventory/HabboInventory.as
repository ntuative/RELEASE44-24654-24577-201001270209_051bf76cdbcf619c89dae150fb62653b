package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1587:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_441,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_100:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_441:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_55.getValue(InventoryCategory.const_625));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_55.getValue(InventoryCategory.const_72));
      }
      ...
      {
         var_193.clubPeriods = param1;
         var_193.clubDays = param2;
         var_193.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_945));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1587);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_55.getValue(InventoryCategory.const_296));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_753.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_753.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_193.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_55.getValue(InventoryCategory.const_457) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1367 = new IncomingMessages(this);
      ...
      {
         return var_193.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_193.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_55.getValue(InventoryCategory.const_234));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_441,roomSessionEventHandler);
         ...
         var_55.add(InventoryCategory.const_457,_loc3_);
         ...
         var_55.add(InventoryCategory.const_72,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_529);
         var_55.add(InventoryCategory.const_234,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_55.add(InventoryCategory.const_625,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_529);
         var_55.add(InventoryCategory.const_296,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_55.add(InventorySubCategory.const_258,_loc8_);
