package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_307:uint = 2;
      
      public static const const_356:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_241:uint = 3;
      
      public static const const_161:uint = 1;
      
      public static const const_170:uint = 0;
      
      public static const const_1324:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_453 = false;
         var_632 = false;
         var_57.updateItemList(var_631);
         var_57.updateItemList(var_1134);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_57.alertPopup(TradingView.const_978);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_632 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_57.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_57.alertPopup(TradingView.const_909);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_46 + " NEW STATE: " + param1 + " OWN: " + var_453 + " OTHER: " + var_632);
         ...
         {
            case const_170:
               if(param1 == const_161 || param1 == const_195)
               {
                  var_46 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_592)
         {
            if(var_46 != const_170 && var_46 != const_195)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_170;
            var_25.toggleInventorySubPage(InventorySubCategory.const_833);
            var_592 = false;
         }
         var_57.setMinimized(false);
      }
