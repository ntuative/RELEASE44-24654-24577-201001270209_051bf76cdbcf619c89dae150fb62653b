package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1814:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1382:ILogger;
      ...
      private var var_79:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_312:
               ...
               break;
            case DisconnectReasonEvent.const_985:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_875:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_815:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1812)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_634 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_634);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1142,var_1813));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1391,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_455.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_455.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1814);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1391,"/");
      ...
      {
         var_634 = _habboConfiguration.getKey("sso.ticket",null);
         var_1142 = _habboConfiguration.getKey("flash.client.url","");
         var_1813 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_171 == null)
         {
         ...
         if(var_634 != null)
         {
            var_79.mode = HabboConnectionType.const_357;
            var_79.initConnection(HabboConnectionType.const_229);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1382 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_79 = param2 as IHabboCommunicationManager;
            _loc3_ = var_79.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_79.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_79.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_79.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_79.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_79.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_79.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_79.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_79.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_79.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_79.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_79.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_79.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_79.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_517);
            _loc3_ = new InitCryptoMessageComposer(var_79.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1814 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_79.mode)
         {
            case HabboConnectionType.const_357:
               _loc6_ = "";
               ...
               var_944 = _loc4_;
               var_171.loadBannerImage(_loc7_ + "?token=" + var_944,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1287:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1124:
               var_945 = generateRandomHexString(30);
               var_455 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_455.init(var_945);
               _loc8_ = var_455.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_944);
         ...
         var _loc9_:IConnection = var_79.getHabboMainConnection(null);
         ...
         var_455 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_945 = generateRandomHexString(30);
            var_455.init(var_945);
            _loc12_ = var_455.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_24,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_100,onRoomSessionEnded);
      }
