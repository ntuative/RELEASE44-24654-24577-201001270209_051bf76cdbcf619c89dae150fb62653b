package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_368:UserInfoCtrl;
      
      private var var_65:ModerationManager;
      
      private var var_916:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_65.issueManager.releaseBundle(var_119.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_368 = new UserInfoCtrl(_window,var_65,_loc3_.message);
         var_916 = new UserInfoCtrl(_window,var_65,_loc3_.message);
         var_368.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_119.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_916.load(_loc4_,var_119.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_65.issueManager.closeBundle(var_119.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_65,WindowTracker.const_866,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_65 != null && false && var_119 != null)
         {
            var_65.issueManager.removeHandler(var_119.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_368 = new UserInfoCtrl(_window,var_65,_loc3_.message);
            var_368.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_65.issueManager.closeBundle(var_119.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_65.issueManager.closeBundle(var_119.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1312;
      }
   }
}
