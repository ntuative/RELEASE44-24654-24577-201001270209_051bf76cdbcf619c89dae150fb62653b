package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1616:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1504:IIssueBrowserView;
      
      private const const_1621:String = "closed_issues";
      ...
      private var var_356:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_356.view.width = var_235.container.width;
         var_356.view.height = var_235.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1615:
               if(var_1504 == null)
               {
                  var_1504 = new MyIssuesView(issueManager,this,var_235.container);
               }
               return var_1504;
            case const_1614:
               if(var_1503 == null)
               {
                  var_1503 = new OpenIssuesView(issueManager,this,var_235.container);
               }
               return var_1503;
            case const_1616:
               if(var_1502 == null)
               {
                  var_1502 = new PickedIssuesView(issueManager,this,var_235.container);
               }
               return var_1502;
            default:
               return null;
