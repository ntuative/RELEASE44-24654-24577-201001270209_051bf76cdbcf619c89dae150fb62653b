package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_588:String = "issue_bundle_my";
      
      public static const const_979:String = "issue_bundle_picked";
      ...
      private var var_548:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_134 = new Map();
         var_787 = new Map();
         var_548 = new IssueBrowser(this,var_65.windowManager,var_65.assets);
         var_642 = [];
         var_788 = [];
         var_961 = new Map();
      }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_642 = var_642.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_787.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_787.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1268)
         {
            var_154.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_134)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_787.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_787.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_142)
         {
            ...
            _loc8_ = var_788.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_548 == null || !var_548.isOpen())
         {
            var_65.soundManager.playSound(HabboSoundTypesEnum.const_805);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_787.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_134.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
