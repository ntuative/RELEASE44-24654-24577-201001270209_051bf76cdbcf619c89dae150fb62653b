package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_734:int = 31536000;
      
      private static const const_736:int = 86400;
      
      private static const const_737:int = 3600;
      
      private static const const_735:int = 60;
      ...
      {
         if(param1 < 2 * const_735)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_737)
         {
            return Math.round(param1 / const_735) + " mins ago";
         }
         if(param1 < 2 * const_736)
         {
            return Math.round(param1 / const_737) + " hours ago";
         }
         if(param1 < 2 * const_734)
         {
            return Math.round(param1 / const_736) + " days ago";
         }
         return Math.round(param1 / const_734) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_60,WindowTracker.const_998,_data.userId),_callerFrame,var_912,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_743.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_60.getXmlWindow("user_info"));
            var_743.addChild(_loc1_);
            var_60.disableButton(var_60.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_60.disableButton(var_60.initMsg.alertPermission,_loc1_,"message_but");
            var_60.disableButton(var_60.initMsg.alertPermission || var_60.initMsg.kickPermission || var_60.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new ModActionCtrl(var_60,_data.userId,_data.userName,var_1196),_callerFrame,var_912,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new RoomVisitsCtrl(var_60,_data.userId),_callerFrame,var_912,false,true);
      }
      ...
      {
         var_60.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_60.messageHandler.addUserInfoListener(this);
         var_60.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_60.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_60 = null;
         _data = null;
         var_743 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_60.windowTracker.show(new SendMsgsCtrl(var_60,_data.userId,_data.userName,var_1196),_callerFrame,var_912,false,true);
      }
