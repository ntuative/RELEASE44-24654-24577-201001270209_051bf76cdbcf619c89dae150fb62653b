package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private static const const_743:uint = 11;
      ...
      private var var_390:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_977:int = -1;
      
      private var var_1200:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1200 = new LagWarningLogger();
         var_1199 = new Array(const_743);
         var _loc4_:int = 0;
         while(_loc4_ < const_743)
         {
            var_1199[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1145,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1166,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1213,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_617,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_517:
            ...
            case HabboCommunicationEvent.const_17:
               ...
               break;
            case HabboCommunicationEvent.const_19:
      ...
      {
         var_95 = IHabboCatalog(param2) as IHabboCatalog;
         var_95.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_95.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_95.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_291:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.addEventListener(HabboConfigurationEvent.const_24,onConfigurationLoaded);
            if(var_224 != null)
            {
               var_224.configuration = var_176;
            }
            if(var_225 != null)
            {
               var_225.configuration = var_176;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_467.events.addEventListener(AdEvent.const_412,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_617,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_517,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_19,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_727,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_59,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_474,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_359:
               var_1200.registerWarning(LagWarningLogger.const_920);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_467)
            {
               var_467.release(new IIDHabboAdManager());
               var_467 = null;
            }
            if(_navigator)
            {
            ...
            if(var_95)
            {
               if(true)
               {
                  var_95.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_95.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_95.release(new IIDHabboCatalog());
               var_95 = null;
            }
            if(var_25)
            {
            ...
            if(var_175)
            {
               if(true)
               {
                  ...
                  Component(var_175).events.removeEventListener(HabboFriendListTrackingEvent.const_291,onFriendlistTrackingEvent);
               }
            ...
            if(var_390)
            {
               if(true)
               {
                  var_390.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_390.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_390.release(new IIDHabboHelp());
               var_390 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_359,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.removeEventListener(HabboConfigurationEvent.const_24,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_15,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_390 = param2 as IHabboHelp;
         var_390.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_390.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_16,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_977 > -1 && _loc2_ < var_977)
         {
            ++var_1435;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1435);
         }
         if(var_977 > -1 && _loc2_ - var_977 > 15000)
         {
            ++var_1434;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1434);
         }
         var_977 = _loc2_;
         if(var_225 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_359,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_175).events.addEventListener(HabboFriendListTrackingEvent.const_291,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_15,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_727)
         {
            trackLoginStep(HabboLoginTrackingStep.const_25);
         }
         else if(param1.type == HabboHotelViewEvent.const_474)
         {
