package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements ICoreUpdateReceiver
   {
      ...
      public static const const_522:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1280 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1280 = 15;
         }
         var_1517 = _window.height;
         var_585 = 4;
         var_407 = 0;
         var_46 = const_338;
         var_189 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1280;
         if(_window.height < var_1517)
         {
            _window.height = var_1517;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_46)
         {
            ...
            case const_387:
               var_859 += param1;
               _loc2_ = Number(var_859) / Number(var_408["time_fade_in"]);
               if(var_859 > int(var_408["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_764:
               var_1021 += param1;
               if(var_1021 > int(var_408["time_display"]) && !var_1281)
               {
                  startFadeOut();
               }
               break;
            case const_763:
               var_858 += param1;
               _loc3_ = 1 - Number(var_858) / Number(var_408["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_858 > int(var_408["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_189.orientation == "TOP" ? int(const_337) : 0;
         var _loc4_:int = var_189.orientation == "BOTTOM" ? int(_loc2_.height - const_337) : int(_loc2_.height);
         var _loc5_:int = var_189.orientation == "LEFT" ? int(const_337) : 0;
         var _loc6_:int = var_189.orientation == "RIGHT" ? int(_loc2_.width - const_337) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
         ...
         if(false)
         {
            if(false)
            {
               _window.y = _loc3_ + var_585;
            }
            else
            {
               _window.y = _loc4_ - 0 - var_585;
            }
         }
         else if(false)
         {
