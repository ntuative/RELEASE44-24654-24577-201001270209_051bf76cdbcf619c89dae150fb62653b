package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1094:String = "pixelbalance";
      
      private static const const_1093:String = "credits";
      
      private static const const_1096:String = "inventory";
      
      private static const const_1095:String = "friendlist";
      
      private static const const_1092:String = "selectfurni";
      ...
      private var var_1259:IHabboToolbar;
      ...
      private var var_206:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_847);
         }
         var _loc6_:Map = var_847["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_893)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1263);
         }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_206 == null)
         {
            return;
         }
         var_206.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_206.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_206.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2076)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_776);
            var_2076 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1186.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         if(param2.type == WindowEvent.const_164 || param2.type == WindowEvent.const_680)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_1004.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1186.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_77)
               {
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_776,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1186.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_206.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1004.push(_loc8_);
         return var_1004.length;
      }
      ...
      {
         var_1259 = IHabboToolbar(param2);
         var_1259.events.addEventListener(HabboToolbarEvent.const_84,onHabboToolbarEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_206 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_206.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_84)
         {
            ...
            var_405 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_847["styles"],var_847["view"],var_1259);
            ...
            var_529.events.addEventListener(BadgeImageReadyEvent.const_112,onBadgeImage);
            var_1259.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
