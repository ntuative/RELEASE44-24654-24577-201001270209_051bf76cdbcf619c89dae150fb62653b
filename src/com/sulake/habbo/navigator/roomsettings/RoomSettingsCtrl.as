package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1156:TextFieldManager;
      
      private var _window:IWindowContainer;
      
      private var var_381:int;
      
      private var var_1157:IWindowContainer;
      ...
      private var var_1159:ICheckBoxWindow;
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in var_101.controllers)
         {
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_101.controllers)
         {
            if(_loc4_.selected)
            {
      ...
      private function controllerExists(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_101.controllers.length)
         {
            _loc3_ = var_101.controllers[_loc2_];
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         --this.var_101.controllerCount;
         var _loc3_:int = 0;
         while(_loc3_ < var_101.controllers.length)
         {
            _loc4_ = var_101.controllers[_loc3_];
            if(_loc4_.userId == param2)
            {
               var_101.controllers.splice(_loc3_,1);
            }
            else
            {
               _loc3_++;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_101.controllers)
         {
            if(_loc1_.selected)
            {
               return true;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_381);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_101.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_381]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         while(_loc9_ < var_101.controllers.length)
         {
            _loc10_ = var_101.controllers[_loc9_];
         ...
         if(var_101.controllers.length > 0)
         {
            _loc1_.visible = true;
            _loc7_.visible = true;
            _loc5_.visible = true;
            if(var_101.controllerCount > var_101.controllers.length)
            {
               _navigator.registerParameter("navigator.roomsettings.flatctrls.limitinfo","cnt","" + var_101.controllers.length);
               _loc6_.visible = true;
            }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_37,HabboWindowParam.const_67,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1850.visible = var_464;
         var_1851.visible = !var_464;
         if(var_464)
         {
         ...
         else
         {
            ...
            var_1157.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1157.findChildByName("picframe")),_navigator.data.enteredGuestRoom.method_1,false);
            var_954.height = Util.getLowestPoint(this.var_954) + 4;
         }
         var_1397.text = !!var_464 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1399.name,var_1157.name,var_954.name,var_956.name,var_1155.name,var_1398.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         var_1400 = false;
         var _loc1_:RoomSettingsData = var_101;
         var_779.setText(_loc1_.name);
         var_1158.setText(_loc1_.description);
         var_955.setText("");
         var_1156.setText("");
      ...
      {
         this.var_381 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_381));
         if(var_952 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.roomId = var_101.roomId;
         _loc2_.name = var_779.getText();
         _loc2_.description = var_1158.getText();
         ...
         {
            _loc8_ = var_955.getText();
            _loc9_ = var_1156.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_955.clearErrors();
               this.var_1156.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = var_1159.isSelected;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_381));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_381 || var_953 < 1)
         {
            return;
         }
         close();
      ...
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         ...
         {
            this.var_101.controllers.splice(0,0,param2);
            ++this.var_101.controllerCount;
         }
         if(var_464)
         {
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_953 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1322)
         {
            this.var_779.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1316)
         {
            this.var_779.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1270)
         {
            this.var_1158.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1201)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1204)
         {
            this.var_955.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_779.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_559,onDoorModePasswordSelect);
         ...
         refreshCategories();
         this.var_779 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1158 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         ...
         this.var_955 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1156 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1160 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1159 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         var_1399 = IWindowContainer(_window.findChildByName("header_container"));
         var_1157 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_954 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_956 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1398 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_1851 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1850 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1397 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1397.procedure = onSwitchView;
         var_952.visible = false;
         if(!_inRoom)
         {
