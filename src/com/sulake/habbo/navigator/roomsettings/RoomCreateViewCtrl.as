package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_845:RoomLayout;
      ...
      private var var_1250:Timer;
      
      private var var_1002:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1250 = new Timer(100);
         var_1250.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_72 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1002 = new TextFieldManager(_navigator,ITextFieldWindow(var_35.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1002.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_2071 = _navigator.data.hcMember;
      }
      ...
      {
         var_1002.goBackToInitialState();
         var_1002.input.textBackgroundColor = 4294967295;
         var_845 = var_72[0];
         if(var_2071 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_37,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_1002.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_845.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1249 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1249 = true;
            _loc3_.y = 1;
