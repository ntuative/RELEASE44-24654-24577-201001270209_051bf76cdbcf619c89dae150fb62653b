package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_321:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1772:ISessionDataManager;
      
      private var var_1773:RoomCreateViewCtrl;
      
      private var var_1626:RoomThumbnailRenderer;
      
      private var var_189:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1123:RoomInfoViewCtrl;
      
      private var var_95:IHabboCatalog;
      
      private var var_418:Tabs;
      
      private var var_442:MainViewCtrl;
      
      private var var_1774:Array;
      
      private var var_955:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_442 = new MainViewCtrl(this);
         var_1123 = new RoomInfoViewCtrl(this);
         var_1773 = new RoomCreateViewCtrl(this);
         var_1626 = new RoomThumbnailRenderer(this);
         var_955 = new GuestRoomPasswordInput(this);
         var_321 = new GuestRoomDoorbell(this);
         var_418 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_442.startSearch(Tabs.const_217,Tabs.const_311,param1);
         var_442.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1772 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_442.startSearch(Tabs.const_238,Tabs.const_205);
         var_418.getTab(Tabs.const_238).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_442.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
