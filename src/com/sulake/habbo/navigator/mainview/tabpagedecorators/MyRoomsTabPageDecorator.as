package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_493;
         }
         if(param1 == 3)
         {
            return Tabs.const_497;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_456 == null ? 0 : int(var_456.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_238,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_456 == null)
         {
            var_456 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_456.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
