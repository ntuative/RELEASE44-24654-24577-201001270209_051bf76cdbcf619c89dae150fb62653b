package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1372,this._model.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1373,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(_active)
         {
            _model.data = _navigator.data.enteredGuestRoom.method_1.getCopy();
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1372 = IButtonWindow(find("top_tab"));
         var_1373 = IButtonWindow(find("obj_tab"));
         var_1725 = IWindowContainer(find("tile_grid"));
         var_1724 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1372,onTopTabButton);
         Util.setProcDirectly(var_1373,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1725;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1724;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_37,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
