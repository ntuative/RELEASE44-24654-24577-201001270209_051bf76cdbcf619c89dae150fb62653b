package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1049:int = -16;
      
      private static const const_742:int = 32;
      ...
      private var var_1154:BitmapData;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_778.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1049,_loc4_.y + const_1051 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1847[param1]);
      }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_778.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_742 / 2);
         return new Point(param1 * const_742 + _loc3_,param2 * const_1050);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1154 == null)
         {
            var_1154 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1154,var_1154.rect,new Point(0,0),null,null,true);
      }
   }
}
