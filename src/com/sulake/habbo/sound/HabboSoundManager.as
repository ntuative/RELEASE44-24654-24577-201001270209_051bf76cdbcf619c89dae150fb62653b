package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManager extends Component implements IHabboSoundManager
   {
      ...
      private function storeVolumeSetting() : void
      {
         if(_connection != null)
         {
            _connection.send(new SetSoundSettingsComposer(int(var_698 * 100)));
         }
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = var_1529.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_805:
               ...
               case HabboSoundTypesEnum.const_1328:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1288:
                  _loc3_ = "sound_message_sent";
                  break;
               case HabboSoundTypesEnum.const_854:
            ...
            var_1529.add(param1,_loc2_);
         }
         _loc2_.volume = var_698;
         _loc2_.play();
      }
   }
}
