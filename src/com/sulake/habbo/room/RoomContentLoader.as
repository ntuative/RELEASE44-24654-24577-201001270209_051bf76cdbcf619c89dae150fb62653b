package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_765:String = "selection_arrow";
      ...
      private static const const_339:String = "place_holder";
      
      private static const const_1105:String = const_339;
      ...
      public static const const_640:String = "RCL_LOADER_READY";
      ...
      private var var_1022:IEventDispatcher = null;
      
      private var var_1283:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         var_2139 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_410 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_327,_loc4_);
      ...
      {
         if(var_185 != null && var_185.hasWorldType(const_272 + param1))
         {
            return var_185.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_279 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_279.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_339,const_490,ROOM_CONTENT,const_766,const_765];
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_167 && _loc5_ != RoomObjectLogicEnum.const_113)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_412.getValue(param1) as String;
      ...
      public function removeObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(false)
         {
            var_279.remove(_loc5_);
         }
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_30:
               var_412.remove(param1);
               break;
            case RoomObjectCategoryEnum.const_28:
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1165);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2139.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1283.add(_loc5_,_loc8_);
               var_185 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_327,_loc5_);
         }
         else
         {
      ...
      {
         if(var_586.getValue(param1) != null)
         {
            return var_586.getValue(param1);
         }
         return "";
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2141)
         {
            ...
            if(var_1022 != null)
            {
               var_1022.dispatchEvent(new Event(const_640));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_185 != null)
         {
            return var_185.getWorldHeightScale(const_272 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1022 = param1;
            var_2140 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2142 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2143 = param2.getKey("public.room.dynamic.download.url","");
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_279.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_411 != null)
         {
            var_411.remove(param2);
            var_411.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_167 && _loc5_ != RoomObjectVisualizationEnum.const_113)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_423.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_279.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1283.getValue(param1) != null)
         {
            var_185 = var_1283.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_185 != null)
         {
            return var_185.getWorldScale(const_272 + param1);
         }
         return 32;
      }
