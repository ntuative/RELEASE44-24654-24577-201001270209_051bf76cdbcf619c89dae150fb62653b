package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1262:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_612:
                  _loc2_.setString(RoomObjectVariableEnum.const_513,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_525:
                  _loc2_.setString(RoomObjectVariableEnum.const_684,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_637:
                  _loc2_.setString(RoomObjectVariableEnum.const_604,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_389:
                  _loc8_ = "null";
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_724:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_960,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1000,int(_loc5_.bgOnly));
            var_1262 = _color;
            var_1499 = var_1099;
            var_1008 = _loc11_;
            var_1500 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_799,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_713,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_85.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_80,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1338,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1326,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1262,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_80,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_136 || _loc13_ == RoomPlaneData.const_259)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_849)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_713,_loc3_);
         }
      }
   }
}
