package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1370:Number = Math.sqrt(0.5);
      ...
      protected var var_1426:String = null;
      ...
      protected var var_2230:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_530[param1] = _loc3_;
            var_531[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1426 != null && var_1426.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_911:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_850:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1780 != param1 || var_1778 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_530[_loc3_] = "";
               var_531[_loc3_] = false;
               _loc3_--;
            }
            var_1780 = param1;
            var_1778 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_1777 != param1 || var_1779 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _selectedColor = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            ...
            var_1426 = _loc3_.getString(RoomObjectVariableEnum.const_289);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_286 != _loc3_.getUpdateID() || param1 != var_211 || param2 != var_2230)
         {
