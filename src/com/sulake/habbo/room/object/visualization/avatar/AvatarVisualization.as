package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1408:int = 0;
      ...
      private var var_833:AvatarVisualizationData = null;
      
      private const const_1085:int = 3;
      ...
      {
         var_833 = param1 as AvatarVisualizationData;
         createSprites(const_1085);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_416.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_590);
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_273);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_286 != _loc3_.getUpdateID() || var_211 != param1.scale || var_166 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_482 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_482;
            _loc23_ = getTimer();
            if(var_544 != _loc7_)
            {
               for each(_loc49_ in var_416.getKeys())
               {
                  var_416.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_833.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_416.remove(_loc5_);
               var_416.add(_loc5_,_loc6_);
               var_544 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_297);
            ...
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_633);
            _loc6_.appendAction(AvatarAction.const_677,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_402);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_50)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_386);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_323,AvatarAction.const_1215[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_806);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_964,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_876);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_915);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_968,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_642);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_572);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_869,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_837);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_813,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_445);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_460) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_554);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_464);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_853);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_688,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_879))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_833.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_;
            ...
            var_211 = param1.scale;
            var_834.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_834)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_416 != null)
         {
            _loc1_ = var_416.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_416.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
