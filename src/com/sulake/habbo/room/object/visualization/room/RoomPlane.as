package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1428:int = 0;
      ...
      private var var_648:IPlaneRasterizer = null;
      ...
      private var var_537:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_1910 = param8;
         var_728 = new Vector3d();
         var_728.assign(param1);
         var_82 = new Vector3d();
         var_82.assign(param2);
         var_246 = new Vector3d();
         var_246.assign(param3);
         var_247 = new Vector3d();
         var_247.assign(param4);
         var_434 = Vector3d.crossProduct(var_246,var_247);
         if(false)
         {
            var_434.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(var_169 != null)
         {
            ...
            {
               _loc3_ = var_169.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_169 != null)
         {
            ...
            {
               _loc2_ = var_169.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = var_169.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_228 || _type == const_179))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_798 || false && false && !var_160 || var_537 == null)
         {
            return;
         }
         ...
         if(var_67 == null || var_67.width != _loc7_ || var_67.height != _loc8_)
         {
            if(var_67 != null)
            {
               var_67.dispose();
            ...
            var_67 = new BitmapData(_loc7_,_loc8_,true,16777215);
            var_160 = true;
         }
         if(var_160)
         {
            ...
            if(var_67 != null)
            {
               var_67.fillRect(var_67.rect,16777215);
            }
            resetTextureCache(param1);
            _loc9_ = param2.getCoordinatePosition(var_434);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_200.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_537.updateMask(var_67,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_647.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_265.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_67.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  var_965.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_160 = false;
         }
         combineTextureMask(param1,var_67);
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_648 != null)
         {
            return var_648.getTextureIdentifier(param1,normal);
         }
      ...
      {
         if(var_129 == null || var_108 == null || var_84 == null || var_109 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_228 || _type == const_179)
         {
      ...
      {
         var_129.assign(param1.getScreenPosition(var_82));
         var_108.assign(param1.getScreenPosition(Vector3d.sum(var_82,var_247)));
         var_84.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_82,var_246),var_247)));
         var_109.assign(param1.getScreenPosition(Vector3d.sum(var_82,var_246)));
         _offset = param1.getScreenPoint(var_728);
         ...
         var _loc2_:Number = Math.min(var_129.x,var_108.x,var_84.x,var_109.x);
         var _loc3_:Number = Math.max(var_129.x,var_108.x,var_84.x,var_109.x);
         var _loc4_:Number = Math.min(var_129.y,var_108.y,var_84.y,var_109.y);
         var _loc5_:Number = Math.max(var_129.y,var_108.y,var_84.y,var_109.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_129.x = 0 - _loc2_;
         var_108.x = 0 - _loc2_;
         ...
         if(true)
         {
            while(_loc1_ < var_200.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_647[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1088.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1088[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_728);
            _loc7_ = _loc6_.z;
         ...
         if(needsNewTexture(param1,param2) || param3)
         {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc4_:PlaneBitmapData = var_169.getValue(_loc3_) as PlaneBitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_434);
            _loc4_ = var_169.getValue(_loc3_) as PlaneBitmapData;
            _loc8_ = null;
            if(_loc4_ != null)
            {
            ...
            if(var_648 != null)
            {
               _loc4_ = var_648.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1423,var_1912,var_1909,var_1908,var_1911,param2);
               if(_loc4_ != null)
               {
