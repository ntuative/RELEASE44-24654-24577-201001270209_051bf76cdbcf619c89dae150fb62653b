package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1238:int = const_275;
      ...
      public static const const_194:int = 4;
      
      public static const const_692:int = 6;
      
      public static const const_239:int = const_102;
      ...
      private var var_754:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1666 = param6;
         var_1665 = param7;
         var_754 = new Vector3d();
         if(var_1368 == const_692)
         {
            var_1106 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1369 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_40.width,var_440);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_440,var_40.width,var_440);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_40 != null)
            {
               if(var_40.width == param2 && var_40.height == param3 && Vector3d.isEqual(var_754,param4))
               {
                  if(param1 != null)
                  {
