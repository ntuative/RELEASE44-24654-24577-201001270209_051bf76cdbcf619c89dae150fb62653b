   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_169.getValue(_loc6_) == null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_169 != null)
         {
            ...
            {
               _loc3_ = var_169.getWithIndex(_loc1_) as PlaneTexture;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return var_169.getValue(param1) as PlaneTexture;
      }
