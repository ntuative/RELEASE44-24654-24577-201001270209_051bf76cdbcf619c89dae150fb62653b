package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_622[var_927] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_289)
         {
            ...
            var_289 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_289.center();
            var_289.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_927;
         if(var_927 < var_622.length)
         {
            _loc1_ = var_622[var_927] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_622.length);
                  _loc2_.text = _loc6_;
               }
