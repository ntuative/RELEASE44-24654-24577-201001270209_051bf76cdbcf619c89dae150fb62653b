package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_227 || var_162 == -1 || !_controller)
         {
            return;
         }
         var_227 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_552,var_162);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1017,const_1018,2,2),null,0) as IWindowContainer;
