package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1017:Number = 100;
      
      private static const const_1018:Number = 100;
       
      
      private var var_1096:XML;
      
      private var var_404:int;
      
      private var var_437:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1692:int;
      
      private var var_322:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1017,const_1018,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_437 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_322 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_437 != null)
         {
            var_437.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_322 != null)
         {
            var_322.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_918 = _loc2_.light;
         if(var_322 != null)
         {
            var_322.setValue(var_918);
         }
         var_404 = colors.indexOf(_loc2_.color);
         if(var_437 != null)
         {
            var_437.setSelectedColorIndex(var_404);
         }
