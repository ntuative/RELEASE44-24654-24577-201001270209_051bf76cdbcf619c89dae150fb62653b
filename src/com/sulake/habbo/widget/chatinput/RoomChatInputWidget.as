package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements ICoreUpdateReceiver
   {
      ...
      private static const const_1072:int = 3000;
      
      private static const const_1073:int = 30000;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_506,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_561,onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_221,onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_556,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_851:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               _visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1229:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_561,onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_556,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_396 > const_1074)
         {
            if(_loc1_ < var_1226 + const_1072)
            {
               var_820 = true;
               var_666 = const_1073 / 1000;
               Logger.log("Enabling flood blocking");
               var_819 = new Timer(1000,var_666);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_583,_visualization.window);
         if(messageListener != null)
         {
