package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1380:int = 5;
      ...
      private static const const_1016:int = 40;
      ...
      private var var_419:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_908 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1634 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1633 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_616 = new Timer(1000,1);
         var_616.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_735 = new Timer(5000,1);
         var_735.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1635 = _loc2_.width + const_479 + _loc6_.width + const_1015;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1016,_loc8_.width) + const_479);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_908 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_130 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_419);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_419);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_436);
