package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_1640 = param1.petRace;
         _image = param1.image;
         include = param1.isOwnPet;
         var_1904 = param1.ownerId;
         _ownerName = param1.ownerName;
         _canOwnerBeKicked = param1.canOwnerBeKicked;
         var_1825 = param1.level;
         var_1899 = param1.levelMax;
         var_1901 = param1.experience;
         var_1898 = param1.experienceMax;
         _energy = param1.energy;
         var_1902 = param1.energyMax;
         _nutrition = param1.nutrition;
         var_1896 = param1.nutritionMax;
         _petRespect = param1.petRespect;
         var_1903 = param1.roomIndex;
         var_1897 = param1.age;
      }
