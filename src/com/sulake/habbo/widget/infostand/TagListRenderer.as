package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1227 != null && var_1227.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_126);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            _offsetX = 0;
            var_821 += param1.height + const_1607;
            return fit(param1);
         }
         param1.offset(_offsetX,var_821);
         _offsetX += param1.width + const_1608;
         return true;
      }
