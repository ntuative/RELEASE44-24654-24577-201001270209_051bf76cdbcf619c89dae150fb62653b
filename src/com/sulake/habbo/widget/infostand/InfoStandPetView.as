package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1594:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1598:String = "level";
      
      private var var_111:IItemListWindow;
      
      private const const_1597:String = "energy";
      
      private var var_1131:Map;
      
      private const const_1592:String = "nutrition";
      
      private var var_69:IItemListWindow;
      
      private const const_1600:uint = 3355443;
      
      private var var_217:IBorderWindow;
      
      private const const_1593:int = 158;
      
      private const const_1599:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_252:PetCommandTool;
      
      private const const_1595:uint = 11184810;
      
      private const const_1596:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_217 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_217 != null)
         {
            var_111 = var_217.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_217.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_217.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_111 == null || var_217 == null || var_69 == null)
         {
            return;
         }
         ...
         var_217.height = NaN;
         _window.width = Math.max(var_217.width,var_69.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1131.getValue(var_630) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1598,param1.level,param1.levelMax);
         updateStateElement(const_1596,param1.experience,param1.experienceMax);
         updateStateElement(const_1597,param1.energy,param1.energyMax);
         updateStateElement(const_1592,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_630 = param1.id;
         var_1131.remove(param1.id);
         var_1131.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1593,const_1599,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1595);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1600);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1594);
         return _loc5_;
      }
