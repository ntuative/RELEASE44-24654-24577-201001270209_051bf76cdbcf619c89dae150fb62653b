package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_851:MeMenuSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_851.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_580 != null)
            {
               _loc2_.bitmap = new BitmapData(var_580.width,var_580.height,true,16777215);
               _loc2_.bitmap.copyPixels(var_580,var_580.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_580 = BitmapData(_loc2_.content);
      }
      
      public function set max(param1:Number) : void
      {
         var_1015 = param1;
         setValue(var_851.volume);
      }
      ...
      {
         return int(var_1505 * (Number(param1 - var_696) / (var_1015 - var_696)));
      }
      ...
      {
         return param1 / var_1505 * (var_1015 - var_696) + var_696;
      }
   }
}
