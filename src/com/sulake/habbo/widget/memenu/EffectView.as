   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_811 = _window.findChildByName("effect_hilite");
            var_811.visible = false;
         }
         var_812 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_810 = _window.findChildByName("loader_bar");
         if(var_810 != null)
         {
            var_419 = var_810.width;
            var_179.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_812 != null)
         {
            var_812.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_812.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
