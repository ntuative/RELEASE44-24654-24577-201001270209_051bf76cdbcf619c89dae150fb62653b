package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1025:Number = 18;
      
      private static const const_1382:Number = 10;
      
      private static const const_1381:Number = 8;
       
      
      private var var_1102:Number;
      ...
      {
         _widget.onItemMouseOut(var_921,var_920,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_921,var_920,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1101 = param1.chatType;
         var_921 = param1.userId;
         var_751 = param1.userName;
         var_920 = param1.userCategory;
         _message = param1.text;
         var_1102 = param1.userX;
         var_190 = param1.userImage;
         var_919 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_94,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1101)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_98:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_222:
         ...
         if(var_190 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_371 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_919 != 0)
            {
               _loc30_ = uint(var_919 >> 16 & 255);
               _loc31_ = uint(var_919 >> 8 & 255);
               _loc32_ = uint(var_919 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1101 == RoomWidgetChatUpdateEvent.const_222)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_751);
            }
            else if(var_1101 == RoomWidgetChatUpdateEvent.const_248)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_479;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_921,var_920,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_921,var_920,_roomId,_roomCategory,param1);
      }
