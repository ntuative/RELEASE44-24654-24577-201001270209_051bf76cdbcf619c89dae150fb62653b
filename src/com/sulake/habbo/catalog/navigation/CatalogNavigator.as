package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2308:String = "magic.pixels";
      
      private var var_2307:String = "catalog.page.club";
      
      private var var_2340:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_95.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_95.configuration.getKey("link.format.credits","/credits");
            var_95.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_95.openCatalogPage(var_2307,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_95.loadCatalogPage(param1.pageId);
         var_95.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_95.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_95.loadCatalogPage(_loc2_.pageId);
         }
