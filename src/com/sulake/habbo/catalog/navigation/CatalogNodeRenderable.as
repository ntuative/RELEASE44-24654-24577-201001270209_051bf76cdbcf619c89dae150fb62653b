package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1392:XML;
      ...
      private var var_1391:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1392 == null)
         {
            ...
            var_1392 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1391 == 4294967295)
            {
               var_1391 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1221;
            }
         }
      }
      ...
      {
         var_59 = navigator.catalog.windowManager.buildFromXML(var_1392) as IItemListWindow;
         if(var_59 == null)
         {
