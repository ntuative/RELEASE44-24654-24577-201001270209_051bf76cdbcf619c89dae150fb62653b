package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_171:int = 5;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1518)
         {
            case RecyclerStatusMessageEvent.const_1139:
               var_280 = const_340;
               if(_view == null)
               {
                  return;
               ...
               var_95.setupInventoryForRecycler(true);
               verifyRoomSessionStatus();
               updateRecyclerSlots();
               updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_940:
               if(_view == null)
               {
                  return;
               }
               _view.displayDisabledView();
               var_95.setupInventoryForRecycler(false);
               break;
      ...
      {
         var_280 = const_768;
         var_107 = new Array(const_171);
         if(param1 == null)
         {
            return;
         }
         _view = param1;
         var_95.getRecyclerStatus();
      }
      ...
      public function storePrizeTable(param1:Array) : void
      {
         ...
         {
            _loc3_ = new PrizeLevelContainer(param1[_loc2_],var_95);
            var_665.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      {
         return active && var_280 == const_340;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_171)
            {
         ...
         var itemId:int = var_95.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_893:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1187:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_95.returnInventoryFurniFromRecycler(var_107[param1].id))
         {
            return;
         }
         var_107[param1] = null;
