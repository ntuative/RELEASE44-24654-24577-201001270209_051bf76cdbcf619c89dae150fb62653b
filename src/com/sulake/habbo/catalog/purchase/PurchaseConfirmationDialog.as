package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1400:uint = 4.293848814E9;
      
      private var var_1275:int;
      
      private const const_1618:uint = 4.291613146E9;
      ...
      private var var_95:HabboCatalog;
      ...
      public function receiverNotFound() : void
      {
         ...
         var_95.windowManager.alert("${catalog.gift_wrapping.receiver_not_found.title}","${catalog.gift_wrapping.receiver_not_found.info}",0,alertHandler);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         var _loc2_:XmlAsset = var_95.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return null;
         }
         return var_95.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_856;
               }
            }
            _loc4_++;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_95.getProductData(var_87.localizationId);
         var _loc2_:String = _loc1_ == null ? "" : _loc1_.name;
         var_95.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc2_);
         var _loc3_:String = "";
         var _loc4_:String = "";
         var _loc7_:String = var_95.getPurse().credits.toString();
         var _loc8_:String = var_95.getPurse().pixels.toString();
         switch(var_87.priceType)
         {
            case Offer.const_476:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits";
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_87.priceInCredits.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_714:
            case Offer.const_420:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits+pixels";
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_87.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_87.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
         ...
         var_95.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc3_);
         var_95.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc4_);
      }
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_856,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1400) : uint(const_1401);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1389;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_95.getFurnitureData(_loc6_,ProductTypeEnum.const_77);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_95.purchaseProduct(var_667,var_87,var_1018);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_856);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_583[var_208]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_582[var_207]);
         var_95.purchaseProductAsGift(var_667,var_87,var_1018,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_135:
               ...
               if(var_2119 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_232)
               {
            ...
            case WindowMouseEvent.const_51:
               ...
               break;
            case WindowKeyboardEvent.const_576:
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_95.getProductData(var_87.localizationId);
            _loc1_.text = _loc3_ == null ? "" : _loc3_.name;
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByName("product_image") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc4_ = var_87.page.viewer.roomEngine;
            _loc6_ = var_87.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_188:
                  _loc7_ = var_95.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_419:
                  _loc7_ = var_95.getSubscriptionProductIcon(_loc6_.productClassId);
            }
            if(_loc5_ != null)
            {
               _loc7_ = _loc5_.data;
      ...
      private function showGiftDialog() : void
      {
         ...
         var _loc1_:GiftWrappingConfiguration = var_95.giftWrappingConfiguration;
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1389 = _loc1_.stuffTypes;
            var_583 = _loc1_.boxTypes;
            var_582 = _loc1_.ribbonTypes;
            var_856 = var_1389[0];
            var_208 = var_583[0];
            var_207 = var_582[0];
            initColorGrid();
      ...
      private function setBitmapData(param1:IWindowContainer, param2:String, param3:String, param4:ColorTransform = null) : void
      {
         ...
         var _loc6_:BitmapDataAsset = var_95.assets.getAssetByName(param3) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            return;
         }
