package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1027 + var_1027 / -var_2311 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_869 - var_869 / var_417 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_417).toString().length - 1);
         var_417 = Math.ceil(var_417 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_417.toString();
         _loc3_.draw(_loc6_);
         var_1027 = param1 - _loc6_.textWidth - 2;
         var_869 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_869);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_869 - 1) / 5 * _loc10_;
         ...
         _loc10_ = 1;
         while(_loc10_ < var_94.length)
         {
            _loc9_.graphics.lineTo(getX(_loc10_),getY(_loc10_));
            _loc10_++;
         }
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1027,(param2 - var_869) / 2));
         return _loc3_;
      }
      
      public function get available() : Boolean
      {
         return var_94 && _y && false;
      }
   }
}
