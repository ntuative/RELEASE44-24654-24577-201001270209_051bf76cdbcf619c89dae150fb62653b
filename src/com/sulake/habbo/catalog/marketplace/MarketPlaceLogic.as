package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1622:int = 3;
      
      public const const_1450:int = 2;
      ...
      private var var_1750:MarketplaceItemStats;
      ...
      {
         if(!var_326 || !var_95 || !var_95.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = var_326.getValue(param1) as MarketPlaceOfferData;
         if(var_95.getPurse().credits < _loc2_.price)
         {
            var_95.showNotEnoughCreditsAlert("${catalog.alert.notenough.credits.description}");
            return;
         }
         showConfirmation(const_1578,_loc2_);
      }
      ...
      public function requestOffers(param1:int, param2:int, param3:String, param4:int) : void
      {
         ...
         if(var_95)
         {
            var_95.getPublicMarketPlaceOffers(param1,param2,param3,param4);
         }
      }
      
      public function requestOwnItems() : void
      {
         var_95.getOwnMarketPlaceOffers();
      }
      ...
      {
         if(param1.furniCategoryId != var_1749 || param1.furniTypeId != var_1751)
         {
            return;
         }
         var_1750 = param1;
      ...
      {
         var_95.getPublicMarketPlaceOffers(-1,-1,param1,-1);
      }
      ...
      private function getConfiguration() : void
      {
         ...
         var_95.connection.send(new GetMarketplaceConfigurationMessageComposer());
      }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            var_326.remove(parser.requestedOfferId);
            showConfirmation(const_1450,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_627.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_627.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_431)
            {
               var_627.remove(_loc2_);
            }
         }
         var_95.redeemSoldMarketPlaceOffers();
         _visualization.listUpdatedNotify();
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1748 = _loc3_.creditsWaiting;
         var_627 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_627.add(_loc4_.offerId,_loc5_);
         }
      ...
      {
         var_95.getPublicMarketPlaceOffers(param1,-1,"",-1);
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_192)
         {
            var_192 = new MarketplaceConfirmationDialog(this,var_95,_roomEngine);
         }
      ...
      {
         requestOffers(var_1744,var_1752,var_1745,var_1746);
      }
      ...
      {
         var_95.redeemExpiredMarketPlaceOffer(param1);
      }
      ...
      public function requestItemStats(param1:int, param2:int) : void
      {
         if(var_95)
         {
            var_1751 = param2;
            var_1749 = param1;
            var_95.getMarketplaceItemStats(param1,param2);
         }
      }
