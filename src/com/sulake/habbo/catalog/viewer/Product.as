package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1298:IProductData;
      ...
      {
         super();
         var_1297 = param1.productType;
         var_1300 = param1.furniClassId;
         var_1029 = param1.extraParam;
         var_1028 = param1.productCount;
         var_1299 = param1.expiration;
         var_1298 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_74:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1029);
               break;
