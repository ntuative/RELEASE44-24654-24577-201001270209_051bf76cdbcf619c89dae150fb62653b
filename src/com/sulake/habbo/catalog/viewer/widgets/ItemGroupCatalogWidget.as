package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_525[var_910] as Array;
      ...
      {
         var _loc2_:Offer = var_525[var_910][var_1645];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_461 || _loc1_.pricingModel == Offer.const_459)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_911.indexOf(_loc5_) == -1)
                        {
                           var_911.push(_loc5_);
                           var_525.push(new Array());
                        }
                        _loc6_ = var_911.indexOf(_loc5_);
                        (var_525[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_525)
         {
            if(var_1645 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1645] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_910 = var_897.getGridItemIndex(param1.view);
