package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1181:MarketPlaceOfferData;
      
      private const const_1387:int = 1;
      
      private const const_1602:int = 40;
      
      private var var_470:IWindowContainer;
      
      private const const_1388:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_470)
         {
            ...
            var_470 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_470)
         {
            return;
         ...
         updateStatusDisplay(const_1388,_loc2_.length);
         if(!var_386)
         {
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_470 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_470.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1387);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_796 >= var_551.length)
            {
               return true;
            }
            addListItem(var_551.getWithIndex(var_796));
            ++var_796;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1181.offerId);
                  hideDetails();
            }
            return;
         }
