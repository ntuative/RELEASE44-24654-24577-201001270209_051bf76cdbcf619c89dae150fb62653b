package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1025 != null)
         {
            var_1025.removeEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1025 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1025 != null)
         {
            var_1025.addEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
