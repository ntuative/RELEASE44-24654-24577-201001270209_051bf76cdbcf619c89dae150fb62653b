package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1287:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_589 != null)
         {
            var_589.visible = false;
            var_589.destroyGridItems();
         }
         if(var_1287 != null)
         {
            var_1287.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1179.text = "${" + _loc3_.name + "}";
            var_1180.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1179.text = "${" + _loc2_.localizationId + "}";
            var_1180.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_424:
                  _loc4_ = var_1288.clone();
                  if(var_589 != null)
                  {
                     var_589.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_589,var_1287,var_1329);
                  }
                  break;
               ...
               case Offer.const_459:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_188:
                        ...
                        _loc4_ = new BitmapData(var_96.width,var_96.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_323,AvatarAction.const_584);
                              _loc13_.appendAction(AvatarAction.const_688,_loc6_.productClassId);
      ...
      {
         var_1179 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1180 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_96 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1519 = new Point(var_96.x,var_96.y);
         var_589 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1287 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_589 == null)
         {
         ...
         var_1288 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_96);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_96.bitmap = new BitmapData(var_96.width,var_96.height,true,16777215);
         }
         var_96.bitmap.fillRect(var_96.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_96.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_96.invalidate();
         var_96.x = var_1519.x;
         var_96.y = var_1519.y;
         if(param2 != null)
