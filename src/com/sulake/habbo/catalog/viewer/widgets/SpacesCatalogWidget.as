package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_179:String = "landscape";
      ...
      private var var_1016:BitmapData = null;
      
      private var var_236:int = 0;
      
      private var var_699:int = 0;
      
      private var var_1255:String = "1.1";
      ...
      private var var_1017:BitmapData = null;
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  case "floor":
                     ...
                     {
                        var_854.push(String(_loc9_.@id));
                        var_1272.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_1016 != null && var_1017 != null)
         {
            setRoomImage(var_1016,var_1017);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_180:
               ...
               if(var_309 == _activeWallpaperPatterns.length)
               {
                  var_309 = 0;
               }
               var_236 = 0;
               ...
               for each(_loc8_ in var_176.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_700 = _loc8_.children().length();
                  }
               }
            ...
            case const_181:
               ...
               for each(_loc9_ in var_176.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_701 = _loc9_.children().length();
                  }
               }
            ...
            case const_179:
               ...
               for each(_loc10_ in var_176.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_699 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1270[var_308];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1255);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1256,var_1255,64,this,"window_romantic_wide");
