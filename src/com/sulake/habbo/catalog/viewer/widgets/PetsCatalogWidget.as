package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_404 >= var_305.length)
         {
            return "";
         }
         var petColor:IPetColor = var_305[var_404] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_571[var_1484] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_404 < 0 || var_404 > var_305.length)
         {
            var_404 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_842 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_305 = [];
         var_571 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_842);
               if(_loc11_)
               {
                  var_571 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_571.length)
         {
            _loc12_ = var_571[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_842,_loc12_.id),getRaceLocalizationKey(var_842,_loc12_.id)));
            _loc6_++;
         }
         var_551.add(var_842,_loc5_);
      ...
      private function updateImage() : void
      {
         ...
         if(var_404 >= 0 && var_404 < var_305.length)
         {
            _loc7_ = var_305[var_404] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_571[var_1484] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_842,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_323,AvatarAction.const_593);
