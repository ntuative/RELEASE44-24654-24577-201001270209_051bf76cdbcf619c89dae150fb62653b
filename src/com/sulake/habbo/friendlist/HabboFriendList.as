package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1576:IAvatarRenderManager;
      
      private var var_1339:AvatarSearchResults;
      
      private var var_140:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_727:FriendRequests;
      
      private var var_1578:int;
      
      var var_346:FriendCategories;
      
      private var var_189:IHabboToolbar;
      
      private var var_1577:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_418:FriendListTabs;
      
      private var var_1579:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1340:OpenedToWebPopup;
      ...
      {
         var_1577 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_346 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1339 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1340 == null)
         {
            var_1340 = new OpenedToWebPopup(this);
         }
         var_1340.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_727.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_727.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_418.findTab(FriendListTab.const_94).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_727.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_346.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_727 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_346.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_346.addCategory(new FriendCategory(FriendCategory.const_905,getText("friendlist.friends")));
         var_346.addCategory(new FriendCategory(FriendCategory.const_467,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_346.addFriend(new Friend(_loc4_));
         }
         var_418 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_346.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_81);
      ...
      {
         var _loc2_:IAvatarImage = var_1576.createAvatarImage(param1,AvatarScaleType.const_96);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1576 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_727.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_418.findTab(FriendListTab.const_94);
      ...
      {
         var_1579 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_346.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_418.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_291));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1339.searchReceived(_loc2_.friends,_loc2_.others);
