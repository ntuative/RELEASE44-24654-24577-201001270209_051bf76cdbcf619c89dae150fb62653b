package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_284 && _loc4_.state != FriendRequest.const_319)
            {
      ...
      {
         var_1448 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1449 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1449.procedure = onDismissAllButtonClick;
         var_1448.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_319;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_319)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1448,_loc1_);
         setEnabled(var_1449,_loc1_);
      }
