package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_703 = param1.online;
         var_1115 = param1.followingAllowed && param1.online;
         var_544 = param1.figure;
         var_1114 = param1.motto;
         var_1113 = param1.lastAccess;
         var_1117 = param1.categoryId;
         var_1116 = param1.realName;
