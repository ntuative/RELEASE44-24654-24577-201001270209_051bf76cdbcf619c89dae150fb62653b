package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_232.length / const_290);
      }
      ...
      {
         if(this.var_840 >= this.getPageCount())
         {
            this.var_840 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_232[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_232.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_840 + 1) * const_290,this.var_232.length);
      }
