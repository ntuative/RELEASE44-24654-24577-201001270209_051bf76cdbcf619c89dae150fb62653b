package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.events.addEventListener(com.sulake.core.localization.enum.LocalizationEvent.const_15,onLocalizationLoaded);
      }
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         if("false" == var_176.getKey("use.default.localizations","false"))
         {
            _loc4_ = var_176.getKey("external.texts.txt","external_texts.txt");
            super.method_3(_loc4_);
         }
         var _loc3_:int = 1;
      ...
      {
         events.dispatchEvent(new Event(com.sulake.habbo.localization.enum.LocalizationEvent.const_15));
      }
   }
}
