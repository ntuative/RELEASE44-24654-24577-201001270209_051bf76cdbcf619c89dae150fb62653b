package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_543 = main.component.userRegistry.getRegistry();
         if(false)
         {
            main.showUI(HabboHelpViewEnum.const_143);
         ...
         var i:int = 0;
         while(i < var_543.length)
         {
            u = var_543.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_543.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_543.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
