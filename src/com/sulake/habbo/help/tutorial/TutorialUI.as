package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_249:String = "TUI_NAME_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_60 = param1;
         var_60.events.addEventListener(HabboHelpTutorialEvent.const_509,onTaskDoneEvent);
         var_60.events.addEventListener(HabboHelpTutorialEvent.const_689,onTaskDoneEvent);
         var_60.events.addEventListener(HabboHelpTutorialEvent.const_510,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_60.hideUI();
         var_60.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_101));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_924 = true;
         if(var_42 != null && (var_42.id == const_249 || var_42.id == const_83))
         {
            showView(const_83);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.width = _loc2_.width + var_1393;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_509:
               var_922 = true;
               if(var_42 != null && var_42.id == const_418)
               {
                  showView(const_83);
               }
               break;
            case HabboHelpTutorialEvent.const_689:
               if(var_42 != null && var_42.id == const_301)
               {
                  var_1107 = true;
                  disposeWindow();
               }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_890)
         {
            showView(const_249);
      ...
      {
         var_923 = true;
         if(var_42 != null && (var_42.id == const_301 || var_42.id == const_83))
         {
            showView(const_83);
         }
      }
      ...
      {
         return var_923 && var_924 && var_922;
      }
   }
}
