package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1865:uint = 11129827;
      ...
      private var var_785:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_60.localization.registerParameter("help.tutorial.name.available","name",var_383);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_383 = var_60.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_60.localization.registerParameter("help.tutorial.name.confirmation","name",var_383);
         }
         if(var_258 == null)
         {
            var_258 = var_60.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_258 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1058:
               break;
            case ChangeUserNameResultMessageEvent.var_1060:
         ...
         _loc5_.visible = true;
         var_785 = new NameSuggestionListRenderer(var_60);
         var _loc6_:int = var_785.render(param3,_loc5_);
         var _loc7_:int = 0;
