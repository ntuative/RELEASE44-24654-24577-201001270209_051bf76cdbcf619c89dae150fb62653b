package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1393:int = 0;
      ...
      private var var_1839:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24654-24577-201001270140");
         var_189 = param5;
         var_112 = new Map();
         var_112.add(HabboHelpViewEnum.const_1131,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_143,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_391,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_254,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_214,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_579,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_322,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_655,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_212,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_112.add(HabboHelpViewEnum.const_865,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_112.add(HabboHelpViewEnum.const_639,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_253 == HabboHelpViewEnum.const_143 || false)
         {
            return;
         }
         if(var_379 == null)
         {
            ...
            var_379 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_379 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_379 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_379 as IWindow);
      ...
      {
         return var_112.getValue(var_253);
      }
      ...
      {
         var_1838 = param1;
         var _loc2_:IHelpViewController = var_112.getValue(HabboHelpViewEnum.const_143) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_212:
               ...
               break;
            case CallForHelpResultEnum.const_933:
               showUI(HabboHelpViewEnum.const_865);
               break;
            case CallForHelpResultEnum.const_802:
      ...
      {
         var _loc3_:* = null;
         if(var_253 == HabboHelpViewEnum.const_143)
         {
            return;
         }
         if(true)
         {
            ...
            var_542.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_542.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_379.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_542[1],var_542[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_542[0],var_542[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.width = _loc1_.width + var_1393;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_189 != null)
            {
               var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_509));
      }
