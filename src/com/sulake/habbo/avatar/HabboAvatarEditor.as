package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_970:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_970.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_968)
         {
            ...
            var_650["null"] = new FigureData(this);
            var_650["null"] = new FigureData(this);
            _loc1_ = var_650["null"];
            _loc2_ = var_650["null"];
            ...
            var_346 = new Map();
            var_346.add(AvatarEditorCategory.const_796,new GenericModel(this));
            var_346.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_346.add(AvatarEditorCategory.const_282,new TorsoModel(this));
            var_346.add(AvatarEditorCategory.const_1120,new LegsModel(this));
            var_346.add(AvatarEditorCategory.const_670,new WardrobeModel(this));
            var_968 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_346.getValue(AvatarEditorCategory.const_670);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_346.getValue(AvatarEditorCategory.const_670);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_970.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1551.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1319.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1367)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1319.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_346.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_388 == null)
            {
               var_388 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_388.addChild(_view.window);
               var_388.center();
               var_388.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_796);
         if(var_176 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1186 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_711,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_970 = var_1186.getFigureData(AvatarType.const_88);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_969 = param3;
         var _loc4_:FigureData = var_650[param2];
         if(_loc4_ == null)
         {
            return;
         }
