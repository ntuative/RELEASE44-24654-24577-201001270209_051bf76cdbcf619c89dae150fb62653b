package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      private var var_460:IWindowContainer;
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_623 = new Dictionary();
         var_623["null"] = new AvatarEditorGridView(param1,FigureData.const_127,param2,param3);
         var_623["null"] = new AvatarEditorGridView(param1,FigureData.const_150,param2,param3);
         var_623["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_623["null"] = new AvatarEditorGridView(param1,FigureData.const_145,param2,param3);
         var_623["null"] = new AvatarEditorGridView(param1,FigureData.const_149,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1059);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_623[var_1374];
         if(_loc2_ == null)
         {
            return;
         }
