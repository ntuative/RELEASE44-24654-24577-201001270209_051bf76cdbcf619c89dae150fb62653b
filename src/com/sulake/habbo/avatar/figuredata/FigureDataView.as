package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1221:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1221 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_472 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_472.bitmap = new BitmapData(var_472.width,var_472.height,true,16777215);
         var_472.bitmap.copyPixels(var_1221,var_1221.rect,new Point(0,0 - 0 - 8));
         var_472.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
