package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2019:PartOffsetData;
      
      private var var_825:AvatarActionManager;
      
      private var var_164:IAssetLibrary;
      
      private var var_2278:IAssetLibrary;
      
      private var var_1331:Boolean = false;
      
      private var var_2018:AvatarRenderManager;
      
      private var var_480:FigureData;
      ...
      private var var_1473:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_164 = param2;
         var_2278 = param3;
         var_480 = new FigureData();
         var_402 = new PartSetsData();
         _animationData = new AnimationData();
         var_1473 = new AvatarStructureDownloadSet();
         var_673 = new AnimationManager();
         var_672 = param4;
         var_2019 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_825.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_672)
         {
            case AvatarType.const_88:
               _loc1_ = var_164.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_402.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_164.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_164.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_480.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_164.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_402.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_164.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_164.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_480.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_825.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_825.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_402.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_402.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_825.getDefaultActionType();
         var _loc7_:Array = var_402.getActiveParts(param3.definition);
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_480.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_480.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_402.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_402.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_88:
               if(var_164.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_164.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_164.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_164.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_672 + " ready to go!");
         if(var_672 == AvatarType.const_88)
         {
            var_402.getPartDefinition("ri").appendToFigure = true;
            var_402.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_88:
               var_1473.add(new AvatarStructureDownload(var_164,_loc5_,var_480));
               break;
            case AvatarType.PET:
         }
         var_1473.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_825 = new AvatarActionManager(var_164,var_672);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_164.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_164.getAssetByName("dance" + _loc1_).content as XML;
            var_673.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_164.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_164.getAssetByName("fx" + _loc1_).content as XML;
            var_673.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_2019.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_480.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_480.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_825.sortActions(param1);
      }
   }
}
