package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2000 = parseInt(_loc2_,16);
         var_1999 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1527,var_1525,var_1526,_alphaMultiplier);
         var_992 = generatePaletteMapForGrayscale(var_1999,var_2000);
      }
      
      public function get reds() : Array
      {
         return var_992.getValue("reds") as Array;
      }
      ...
      {
         return var_992.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_992.getValue("greens") as Array;
      }
      ...
      {
         return var_992.getValue("alphas") as Array;
      }
