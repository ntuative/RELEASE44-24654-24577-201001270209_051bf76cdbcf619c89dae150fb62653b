package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1551:IWindowContainer;
      
      public static var var_1319:IWindowContainer;
      
      public static var var_1059:int = 6710886;
      ...
      private var var_1421:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1319 == null)
         {
            ...
            var_1319 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1551 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1551 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_612 != null)
         {
            toggleCategoryView(var_612,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1421 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_612 = param1;
         var_1421.setSelected(var_1421.getSelectableByName(param1));
         _window.invalidate();
      }
