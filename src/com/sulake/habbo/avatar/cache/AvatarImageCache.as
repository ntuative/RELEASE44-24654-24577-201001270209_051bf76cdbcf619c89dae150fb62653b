package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1389:int = 60000;
      ...
      private var var_757:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_80.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_681)
               {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,(var_757 as AvatarImage).getFigure(),_loc6_,var_1120,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_197,var_1120);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_80.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_783 || _loc32_ == AvatarAction.const_596) && (_loc6_ == AvatarBodyPartType.const_282 || _loc6_ == AvatarBodyPartType.const_1303 || _loc6_ == AvatarBodyPartType.const_1271) && _loc7_.color != null)
               {
