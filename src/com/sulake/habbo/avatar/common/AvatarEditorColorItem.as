package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1588:int = 8947848;
      
      private const const_1589:int = 13421772;
      ...
      private var var_762:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_714.width,var_714.height,true,0);
            _loc1_.bitmap.copyPixels(var_714,var_714.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1128.width,var_1128.height,true,0);
            _loc4_ = var_1128.clone();
            _loc4_.colorTransform(_loc4_.rect,var_762.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_936.width,var_936.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_936,var_936.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1379,var_1379.rect,new Point(0,0),null,null,true);
            }
         }
      }
