package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_629 > -1)
         {
            return var_329[var_629] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_629 >= 0)
         {
            _loc3_ = var_329[var_629];
            _loc3_.isSelected = false;
         }
         if(var_329.length > param1)
         {
            _loc2_ = var_329[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_629 = param1;
