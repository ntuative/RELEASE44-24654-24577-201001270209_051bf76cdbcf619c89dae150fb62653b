package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_560:Number = 64;
      ...
      private var var_2303:Number = 500;
      ...
      private var var_2304:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_93 = new Vector3d();
         var_987 = new Vector3d();
         var_1463 = 1;
         var_1464 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1465 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            var_94.assign(_loc23_);
            _y.assign(_loc24_);
            var_93.assign(_loc25_);
         }
         else
         {
            var_94.assign(_loc18_);
            _y.assign(_loc19_);
            var_93.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_399 != param1 * var_1465)
         {
            var_399 = param1 * var_1465;
            ++var_86;
         }
      }
      ...
      {
         if(var_401 != param1 * var_1463)
         {
            var_401 = param1 * var_1463;
            ++var_86;
         }
      }
      ...
      {
         if(var_398 != param1 * var_1464)
         {
            var_398 = param1 * var_1464;
            ++var_86;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_987.assign(_loc22_);
         }
         else
         {
            var_987.assign(_loc17_);
         }
         ++var_86;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_82);
         _loc2_.x *= var_401;
         _loc2_.y *= var_398;
         _loc2_.z *= var_399;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_987);
         if(_loc3_ < var_2304 || _loc3_ > var_2303)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_94);
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_82);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_401;
            _loc2_.y *= var_398;
            _loc2_.z *= var_399;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_987);
         }
      ...
      {
         return new Vector3d(0 * var_401,0 * var_398,0 * var_399);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_94);
         var _loc3_:Number = Vector3d.scalarProjection(param1,_y);
         var _loc4_:Number = Vector3d.scalarProjection(param1,var_93);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_93.x,var_93.y,var_93.z);
      }
      
      public function isZoomedIn() : Boolean
      {
         return scale == const_560;
      }
      ...
      {
         if(param1 == null || var_93 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(var_93,param2);
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_82.assign(param1);
         var_82.x = 0 / var_401;
         var_82.y = 0 / var_398;
         var_82.z = 0 / var_399;
         if(var_82.x != _loc2_ || var_82.y != _loc3_ || var_82.z != _loc4_)
         {
            ++var_86;
         }
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_94,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_401,0 * var_398,0 * var_399);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_93;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_401,param2.y * var_398,param2.z * var_399);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_401,param3.y * var_398,param3.z * var_399);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_401,param4.y * var_398,param4.z * var_399);
