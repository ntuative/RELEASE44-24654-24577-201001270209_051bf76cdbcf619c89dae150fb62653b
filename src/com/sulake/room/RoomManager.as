package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_883:XML = null;
      
      private var var_46:int = 0;
      
      private var var_126:IRoomManagerListener;
      ...
      private var var_506:IRoomObjectFactory = null;
      
      private var var_1501:int;
      
      private var var_2346:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_507 = [];
         var_501 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_327,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_423.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_423.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_506.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_506 = param2 as IRoomObjectFactory;
      ...
      public function removeObjectUpdateCategory(param1:int) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = var_116.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_116 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_116.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc2_:IRoomInstance = var_116.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_506 != null)
         {
            return var_506.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_126 != null)
            {
               var_126.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_126 != null)
            {
               var_126.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_126 != null)
         {
            var_126.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_116.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         return var_116.getValue(param1) as IRoomInstance;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_54.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               var_46 = ROOM_MANAGER_INITIALIZED;
               if(var_126 != null)
               {
                  var_126.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_46 = const_494;
            var_126.roomManagerInitialized(false);
         }
      }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = var_116.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = var_116.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_423.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_423.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_506.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_126 != null)
                                 {
                                    var_126.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         if(var_116.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         var_116.add(String(param1),_loc3_);
         var _loc4_:int = -1;
         while(_loc4_ >= 0)
         {
            _loc5_ = 0;
