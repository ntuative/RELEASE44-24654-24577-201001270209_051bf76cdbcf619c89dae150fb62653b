package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_888:RoomObjectLocationCache;
      ...
      private var var_2215:Number = -10000000;
      
      private var var_2214:Number = -10000000;
      ...
      private var var_1052:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_61 = new Sprite();
         var_61.name = "canvas";
         var_61.mouseEnabled = false;
         _master.addChild(var_61);
         var_61.mouseEnabled = true;
         var_61.doubleClickEnabled = true;
         var_61.addEventListener(MouseEvent.CLICK,clickHandler);
         var_61.addEventListener(MouseEvent.DOUBLE_CLICK,clickHandler);
         ...
         var_888 = new RoomObjectLocationCache(_loc6_);
         var_312 = new Map();
      ...
      public function update() : void
      {
         if(var_1055 == 0)
         {
            checkMouseHits(var_1054.x,var_1054.y,MouseEvent.MOUSE_MOVE);
         }
         var_1055 = 0;
         ++var_1545;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_283 != null)
         {
            var_283.graphics.clear();
         }
         else
         {
            var_283 = new Sprite();
            var_283.name = "mask";
            _master.addChild(var_283);
         }
         var_283.graphics.beginFill(0);
         var_283.graphics.drawRect(0,0,param1,param2);
         var_1051 = param1;
         var_1053 = param2;
         var_61.graphics.clear();
         var_61.graphics.beginFill(var_19);
         var_61.graphics.drawRect(0,0,param1,param2);
         var_61.mask = var_283;
      }
      ...
      {
         var _loc11_:Number = param1 - var_1051 / 2;
         var _loc12_:Number = param2 - var_1053 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc6_ < var_241.length)
         {
            var_241.splice(_loc6_);
         }
         var_241.sortOn("z",0 | 0);
         var _loc10_:* = null;
         var _loc11_:int = 0;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc10_ = var_241[_loc5_] as SortableSprite;
            updateSprite(_loc5_,_loc10_);
            _loc10_.bitmapData = null;
            _loc10_.sprite = null;
            _loc5_++;
         }
         cleanSprites(var_241.length);
         var_2216 = param1;
         var _loc12_:int = getTimer();
         var_719.push(_loc12_ - _loc2_);
         if(var_719.length == const_775)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_775)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_512.length)
            {
               cleanSprite(var_512[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_512 = [];
         }
         ...
         while(_loc1_ < var_312.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1052 != null)
                  {
                     var_1052.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1545,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_61.numChildren)
         {
            return null;
         }
         return var_61.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         while(_loc5_ >= param1)
         {
            _loc3_ = var_61.getChildAt(_loc5_);
            _loc6_ = null;
      ...
      {
         if(param1 < 0 || param1 >= var_241.length)
         {
            return null;
         }
         return var_241[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = var_61.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_513.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_513.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2215 || param2 != var_2214)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_513.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_513.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_512.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= var_61.numChildren)
         {
            var_61.addChild(_loc3_);
         }
         else
         {
            var_61.addChildAt(_loc3_,param2);
         }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(param1 >= var_61.numChildren)
         {
            createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = var_61.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
            {
               var_61.removeChildAt(param1);
               var_512.push(_loc4_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:int) : int
      {
         ...
         var _loc6_:int = _loc5_.spriteCount;
         var _loc7_:IVector3d = var_888.getScreenLocation(param1,_geometry);
         if(_loc7_ == null)
         {
            return 0;
         }
         ...
         _loc8_ += int(var_1051 / 2);
         _loc9_ += int(var_1053 / 2);
            ...
            if(_loc13_ != null && _loc13_.visible)
            {
               ...
               if(_loc17_ != null)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     ...
                     if(_loc14_ < var_1051 && -_loc14_ <= _loc19_.width && (_loc15_ < var_1053 && -_loc15_ <= _loc19_.height))
                     {
                        if(_loc11_ < var_241.length)
                        {
                           _loc12_ = var_241[_loc11_];
