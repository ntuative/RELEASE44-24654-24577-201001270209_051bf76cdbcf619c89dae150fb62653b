package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_858:String = "AssetLibraryReady";
      
      public static const const_1182:String = "AssetLibraryUnloaded";
      
      public static const const_384:String = "AssetLibraryLoaded";
      
      public static const const_1136:String = "AssetLibraryLoadError";
       
      
      private var var_459:XML;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_377)
         {
            _loc4_ = AssetTypeDeclaration(var_377[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_378)
         {
            _loc2_ = var_378[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_378[_loc1_];
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_459 = _loc2_.manifest.copy();
         var_334 = _loc2_.resource;
         if(var_458)
         {
            AssetLibrary.fetchLibraryContents(this,var_459,var_334);
         }
         var_292 = true;
         dispatchEvent(new Event(AssetLibrary.const_384));
         dispatchEvent(new Event(AssetLibrary.const_858));
         if(var_458)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_378[param2.url];
         if(_loc4_ != null)
         {
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_377.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_377[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_333.length ? getAssetByName(var_333[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_377)
         {
            _loc3_ = AssetTypeDeclaration(var_377[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_636[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_1327);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_459.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_378[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_333.splice(var_333.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_377[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
