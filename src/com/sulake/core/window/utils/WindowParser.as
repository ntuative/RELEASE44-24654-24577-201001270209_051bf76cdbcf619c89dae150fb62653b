package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1564:String = "_INCLUDE";
      
      public static const const_880:String = "_EXCLUDE";
      
      public static const const_1566:String = "_TEMP";
      
      private static const const_1033:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1032:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1065:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_893:Dictionary;
      
      protected var var_1323:Map;
      
      protected var var_29:IWindowContext;
      
      protected var var_1324:Dictionary;
      
      protected var var_1066:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1066,var_1065);
         var_893 = new Dictionary();
         var_1324 = new Dictionary();
         ParamCodeTable.fillTables(var_893,var_1324);
         var_1323 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1032,"");
         return param1.replace(const_1033,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1066)
            {
               delete var_1066[_loc1_];
            }
            for(_loc1_ in var_1065)
            {
               delete var_1065[_loc1_];
            }
            for(_loc1_ in var_893)
            {
               delete var_893[_loc1_];
            }
            for(_loc1_ in var_1324)
            {
               delete var_1324[_loc1_];
            }
            var_1323.dispose();
            var_1323 = null;
            var_29 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_880) == -1)
                  {
