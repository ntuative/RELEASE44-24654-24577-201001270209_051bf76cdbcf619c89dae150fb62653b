package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_670:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_466:
               ...
               break;
            case WindowRedrawFlag.const_860:
               var_669 = var_670.getTheActualState(param1.type,param1.style,param1.state);
               if(var_669 != var_990)
               {
                  var_230 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_961:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  var_230 = true;
                  _loc4_ = true;
      ...
      {
         return var_670.getTheActualState(param1.type,param1.style,param1.state) != var_990;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_753) : uint(const_485);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_669) ? uint(const_754) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_485)
         {
            if(var_104 == null)
            {
               var_104 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_230 = true;
            }
            else if(var_104.width != _loc7_ || var_104.height != _loc8_)
            {
               _drawBufferAllocator.free(var_104);
               var_104 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_230 = true;
            }
         }
         ...
         if(_loc5_ != const_485)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_754)
               {
                  ...
                  {
                     var_230 = false;
                     var_104.fillRect(var_104.rect,param1.color);
                     _loc6_.draw(param1,var_104,var_104.rect,var_669,false);
                     if(!param1.background)
                     {
                        _loc10_ = uint(param1.color);
                        if((_loc10_ & 16777215) < 16777215)
                        {
                           var_104.colorTransform(_loc4_.rect,new ColorTransform(((_loc10_ & 16711680) >> 16) / 255 * 1,((_loc10_ & 65280) >> 8) / 255 * 1,(_loc10_ & 255) / 255 * 1));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_104,var_898,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
                     _loc4_.copyPixels(var_104,param3,param2,null,null,true);
                  }
               }
      ...
      {
         var _loc2_:ISkinRenderer = var_670.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_889)
            {
               _loc2_ = var_670.getSkinRendererByType(param1.type,WindowStyle.const_889);
            }
         }
         return _loc2_;
      }
