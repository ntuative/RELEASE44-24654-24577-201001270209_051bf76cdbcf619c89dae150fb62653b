package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1087:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2059 = new Dictionary();
         TypeCodeTable.fillTables(var_1483,var_2059);
         var_1246 = new Dictionary();
         var_2058 = new Dictionary();
         StateCodeTable.fillTables(var_1246,var_2058);
         ...
         {
            var_365 = new Array();
            var_365.push(WindowState.const_62);
            var_365.push(WindowState.const_68);
            var_365.push(WindowState.const_86);
            var_365.push(WindowState.const_46);
            var_365.push(WindowState.const_76);
            var_365.push(WindowState.const_71);
            var_365.push(WindowState.const_90);
            var_365.push(WindowState.const_78);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1246)
         {
            _loc3_.push(var_1246[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1483[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_569[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_569[param1] = new Array(SkinContainer.const_1087);
         }
         var_569[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_569[_loc1_]).dispose();
