package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_609:uint = 0;
      ...
      public static const const_1425:uint = 64;
      ...
      protected var var_1558:Boolean;
         ...
         if(var_606)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1558,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1558,16777215);
                  }
                  var_366 += bitmap.width * bitmap.height * 4;
               }
