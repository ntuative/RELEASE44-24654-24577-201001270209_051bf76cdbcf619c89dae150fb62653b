package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private var var_693:Matrix;
      
      protected var var_604:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_604 = new Dictionary(false);
         var_603 = new Dictionary(false);
         var_693 = new Matrix();
      }
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_604[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_348)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_230)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_348)
                  {
                     _loc15_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_230)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_230 || _loc11_.scaleH == SkinLayoutEntity.const_230)
                  {
                  ...
                  {
                     var_693.a = _loc13_.width / _loc19_.width;
                     var_693.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_693);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_693,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_693 = null;
         for(_loc1_ in var_604)
         {
            _loc2_ = var_604[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_604[_loc1_];
         }
         var_604 = null;
         for(_loc1_ in var_603)
         {
            _loc2_ = var_603[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_603[_loc1_];
         }
         var_603 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_603[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
