   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            ...
            var_64 = var_360.clone();
            var_22 = var_360.clone();
         ...
         if(param7 != null)
         {
            ...
            if(var_31)
            {
               var_29.invalidate(this,var_22,WindowRedrawFlag.const_69);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_129,WindowParam.const_147);
         var _loc2_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_146);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
      ...
      {
         var_5 = param1;
         var_601 = !!var_5 ? uint(var_601 | var_1325) : uint(var_601 & 16777215);
      ...
      {
         if(var_46 == WindowState.const_422)
         {
            return true;
         }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1846 + "]";
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_835,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_903;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_29.invalidate(this,var_22,WindowRedrawFlag.const_961);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_949 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_293,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_721);
      }
      
      public function set color(param1:uint) : void
      {
         var_1325 = param1 & 4278190080;
         var_601 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         var_29.invalidate(this,var_22,WindowRedrawFlag.const_69);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_926;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_190:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_349,this,null));
                     if(testParamFlag(WindowParam.const_162,WindowParam.const_147))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_155,WindowParam.const_146))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_434:
                  var_29.invalidate(this,var_22.union(var_64),WindowRedrawFlag.const_466);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_852,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_281:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_538,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_193,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_346:
                  var_29.invalidate(this,var_22,WindowRedrawFlag.const_860);
                  break;
               case WindowNotifyEvent.const_371:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_343:
                  if(!(var_30 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_29.invalidate(this,var_22,WindowRedrawFlag.const_466);
                     }
                  }
                  else if(var_30 & 0)
                  {
      ...
      {
         return var_602 != null ? var_602 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_721);
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_794,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_949 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_347)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_355)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_30 & 0);
            if(_loc7_ == WindowParam.const_446)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_465)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_624,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_434,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_190,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1240,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1233;
         update(this,_loc1_);
         return true;
      }
         ...
         if(_drawable && var_721 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1395,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1395,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_29.invalidate(this,param1,WindowRedrawFlag.const_69);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               ...
               var_64.width = var_22.width;
               var_64.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_440,this,var_23));
            }
            else
            {
               var_293.x = 0;
               ...
               var_293.width = 0;
               var_293.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_952,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_89,var_30,var_29,var_22,null,var_602,properties,var_600.concat(),_id) as WindowController;
         _loc2_.var_721 = var_721;
         _loc2_._drawable = _drawable;
         _loc2_.var_1327 = var_1327;
      ...
      {
         var _loc3_:uint = var_46;
         var _loc4_:*;
         var_46 = !!param2 ? (_loc4_ = var_46 | param1, var_46 |= param1, uint(_loc4_)) : (_loc4_ = var_46 & ~param1, var_46 &= ~param1, uint(_loc4_));
         if(var_46 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_346,this,null));
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1348,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_516;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_699;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_721 = param1 > 255 ? 255 : uint(param1);
      }
