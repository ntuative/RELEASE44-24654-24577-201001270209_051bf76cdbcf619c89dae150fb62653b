package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1019:String = "content";
      
      private static const const_1020:String = "selector";
       
      
      private var var_1078:Boolean = false;
      
      protected var var_891:ITabSelectorWindow;
      
      private var var_759:Boolean = false;
      
      protected var var_1555:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1555 == null)
         {
            var_1555 = findChildByTag(TabContextController.const_1019) as IWindowContainer;
         }
         return var_1555;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_891 == null)
         {
            var_891 = findChildByTag(TabContextController.const_1020) as ITabSelectorWindow;
            if(var_891 != null)
            {
               var_891.procedure = selectorEventProc;
            }
         }
         return var_891;
      }
      ...
      {
         return !!var_759 ? selector.iterator : null;
      }
