package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_852:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_357)
         {
            ...
            if(var_357)
            {
               var_357.addEventListener(WindowEvent.const_233,scrollBarEventProc);
               var_357.addEventListener(WindowEvent.const_184,scrollBarEventProc);
            }
         }
         return var_357;
      }
      ...
      override public function dispose() : void
      {
         if(var_357)
         {
            var_357.removeEventListener(WindowEvent.const_233,scrollBarEventProc);
            var_357.removeEventListener(WindowEvent.const_184,scrollBarEventProc);
            var_357 = null;
         }
         if(var_852)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_184)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_852)
         {
            var_852 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_852;
      }
