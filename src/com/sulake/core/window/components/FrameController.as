package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1101:String = "_CONTENT";
      ...
      private var var_1268:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_762,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_76)
         {
            ...
            var_76 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_76;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1268 == null)
         {
            var_1268 = findChildByTag(const_1102) as IHeaderWindow;
            if(!var_1268)
            {
      ...
      {
         return content != null && var_1331 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_35 == null)
         {
            var_35 = findChildByTag(const_1101) as IWindowContainer;
            if(!var_35)
            {
