package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2301:Rectangle = new Rectangle();
       
      
      protected var var_212:Boolean;
      
      protected var var_76:TextMargins;
      
      protected var var_519:String = "none";
      ...
      protected var var_725:Boolean = false;
      ...
      {
         var_76 = new TextMargins(0,0,0,0,setTextMargins);
         var_212 = false;
         var_605 = 0;
         var_363 = 0;
         if(_field == null)
      ...
      {
         return new Rectangle(var_605 * maxScrollH,var_363 * maxScrollV,width,height);
      }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_76.dispose();
            var_76 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_938,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_607,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_607,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_76.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_76.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_76.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_76.bottom,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("auto_size",var_519,PropertyStruct.STRING,var_519 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_607,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_76 = var_76.clone(_loc1_.setTextMargins);
         _loc1_.var_519 = var_519;
         _loc1_.var_725 = var_725;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_519 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_519 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_519 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_519 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
