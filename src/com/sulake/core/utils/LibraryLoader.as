package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1376:uint = 2;
      
      protected static const const_1378:uint = 1;
      
      protected static const const_1375:int = 5;
      
      protected static const const_1104:uint = 7;
      
      protected static const const_1377:uint = 4;
      
      protected static const const_1379:uint = 3;
       
      
      protected var var_901:int;
      
      protected var var_2237:String = "";
      
      protected var var_364:int;
      
      protected var var_459:XML;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_459 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_364 + " for file \"" + var_1.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
         ...
         if(var_431 == LibraryLoader.const_1379)
         {
            if(analyzeLibrary())
            {
               var_431 |= 0;
         ...
         if(var_431 == LibraryLoader.const_1104)
         {
            var_1331 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_901 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_317,const_1375 - var_901);
               var_1.load(var_317,var_29);
               --var_901;
               return true;
            }
