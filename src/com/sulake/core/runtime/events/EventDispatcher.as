package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1024:uint = 1;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_739)
            {
               Core.crash("Error catched in EventDispatcher; some event listener crashed!",99,var_1360);
            }
            return _result == const_478;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1024) : uint(const_478);
      }
