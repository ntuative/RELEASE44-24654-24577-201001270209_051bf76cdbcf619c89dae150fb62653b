package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_906:uint = 4;
      ...
      protected var var_376:uint = 0;
      
      protected var var_29:IContext = null;
      
      protected var var_1822:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_902 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_902);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1063 & const_906)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_376 + "]";
      }
   }
}
