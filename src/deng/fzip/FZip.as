package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !!var_56 ? 0 : uint(0);
      }
      
      public function getFileAt(param1:uint) : FZipFile
      {
         return !!var_56 ? var_56[param1] as FZipFile : null;
      }
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8") : FZipFile
      {
         ...
         if(param1 >= var_56.length)
         {
            var_56.push(_loc5_);
         }
         else
         {
            var_56.splice(param1,0,_loc5_);
         }
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_439 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_535))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_535,e.message));
         }
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && false)
         {
            ...
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < var_56.length)
            {
               _loc8_ = var_56[_loc7_] as FZipFile;
               if(_loc8_ != null)
               {
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_99 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_535,"EOF"));
            }
         }
      }
      ...
      {
         if(var_439.parse(param1))
         {
            var_56.push(var_439);
            if(false)
            {
               var_131["null"] = var_439;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1217,var_439));
            var_439 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_56 != null && var_131 != null && param1 < var_56.length)
         {
            _loc2_ = var_56[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_56.splice(param1,1);
      ...
      {
         return addFileAt(!!var_56 ? 0 : uint(0),param1,param2);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8") : FZipFile
      {
         return addFileFromStringAt(!!var_56 ? 0 : uint(0),param1,param2,param3);
      }
   }
}
